...
{
    //Initial attempt at the recoil system, referencing outside code. Its clean, and pretty, but doesn't really do much.
    //I also don't truly understand it and can't fix a couple of bugs that really bring it down.
    ...
    void Update()
    {
        if (Input.GetKey(KeyCode.Mouse0) && !hitscanWeapon.reloading)
        {
            Fire();
        }
